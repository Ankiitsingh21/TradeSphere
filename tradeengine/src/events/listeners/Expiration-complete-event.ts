import { ExpirationCompleteEvent, Listener, Subjects, TradeStatus } from "@showsphere/common";
...
export class ExpirationCompleteListener extends Listener<ExpirationCompleteEvent>  {
        ...
        async onMessage(data: ExpirationCompleteEvent['data'],msg:Message ){
                ...
                if(orderRecord.status===TradeStatus.PENDING){
                        ...
                        const releaseamount= Number(orderRecord.totalQuantity)*Number(orderRecord.price);
                ...
                if(orderRecord.status === TradeStatus.PARTIAL){
                        ...
                        const unmatchedQty = Number(orderRecord.totalQuantity)-Number(orderRecord.matchedQuantity);
